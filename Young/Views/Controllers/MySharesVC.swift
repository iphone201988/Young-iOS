...
class MySharesVC: UIViewController {
    ...
    private func getPosts(isResetPageNo: Bool = false) {
        ...
        //var params = ["userType": UserDefaults.standard[.loggedUserDetails]?.role ?? "", "page": pageNo] as [String : Any]
        
        var params = ["page": pageNo] as [String : Any]
...
extension MySharesVC: UICollectionViewDataSource,
...
extension MySharesVC: UITableViewDelegate,UITableViewDataSource {
...
extension MySharesVC: FSCalendarDataSource, FSCalendarDelegate, FSCalendarDelegateAppearance {
...
extension MySharesVC: UIScrollViewDelegate {
